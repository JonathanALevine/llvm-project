# Install script for directory: /home/jonathan/dev/llvm-project/llvm/tools/llvm-exegesis
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xllvm-exegesisx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/jonathan/dev/llvm-project/bin/llvm-exegesis")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-exegesis" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-exegesis")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-exegesis"
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/home/jonathan/dev/llvm-project/tools/llvm-exegesis/lib/cmake_install.cmake")
endif()
