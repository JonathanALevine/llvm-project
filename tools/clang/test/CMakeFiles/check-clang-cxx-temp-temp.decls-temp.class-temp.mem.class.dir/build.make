...
tools/clang/test/CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class-temp.mem.class:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/jonathan/dev/llvm-project/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running lit suite /home/jonathan/dev/llvm-project/clang/test/CXX/temp/temp.decls/temp.class/temp.mem.class"
	cd /home/jonathan/dev/llvm-project/tools/clang/test && /usr/bin/python3.12 /home/jonathan/dev/llvm-project/./bin/llvm-lit -sv --param USE_Z3_SOLVER=0 /home/jonathan/dev/llvm-project/clang/test/CXX/temp/temp.decls/temp.class/temp.mem.class
...
tools/clang/test/CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class-temp.mem.class.dir/clean:
	cd /home/jonathan/dev/llvm-project/tools/clang/test && $(CMAKE_COMMAND) -P CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class-temp.mem.class.dir/cmake_clean.cmake
